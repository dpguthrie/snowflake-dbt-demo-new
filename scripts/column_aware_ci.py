...
"""
Edge cases
- No data exists in deferring environment
- Modified model doesn't have metadata in deferred environment (imagine it's a view
  and not being run actively in production)
- Limited by our own CLL -> example is in this repo for hardcoded / dynamic pivot
- 
"""
...
if __name__ == "__main__":
    ...
    cmd = ["uv", "tool", "run", "dbt", "compile", "--select", "state:modified"]
    ...
    # Could also just have the user specify the deferring env ID to skip this step
