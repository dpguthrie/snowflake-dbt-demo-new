...
{% macro join_snapshots(
    ...
    cte_join_id,
    cte_join_on_id,
    cte_join_valid_from="effective_start_ts",
    cte_join_valid_to="effective_end_ts",
    cte_join_on_valid_from="effective_start_ts",
    cte_join_on_valid_to="effective_end_ts"
) %}
