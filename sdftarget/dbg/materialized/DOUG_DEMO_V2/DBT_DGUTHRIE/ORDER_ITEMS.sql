...
create or replace view DOUG_DEMO_V2.DBT_DGUTHRIE.ORDER_ITEMS as (with orders as (
...
comment if exists on view DOUG_DEMO_V2.DBT_DGUTHRIE.ORDER_ITEMS IS 'Intermediate model where we calculate item price, discounts and tax. This model is at the order item level.';
